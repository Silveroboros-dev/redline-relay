...
- If the developer asks a substantive question about the candidate, metric tradeoff, operational impact, recommendation, or what the coding assistant would do next, delegate to the AI Agent Integration before answering.
...
If the developer asks a follow-up question, briefly say one bridge line such as "Checking with the coding advisor" and delegate. Read the returned answer without adding new facts.
